    ...
    <div className="max-w-5xl mx-auto space-y-6 py-4">
      ...
      <div className="bg-surface rounded-panel p-4 sm:p-6 border border-line shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-colors">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2.5 bg-accent hover:bg-accent-strong text-canvas font-semibold text-xs sm:text-sm rounded-control flex items-center justify-center space-x-2 shadow-sm transition-all cursor-pointer min-h-[40px]"
        >
              ...
              >
                ...
                <div className="p-4 sm:p-5 space-y-3 flex-1 flex flex-col justify-between">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-[10px] text-ink-faint font-medium min-w-0">
                      <span className="flex items-center gap-1 shrink-0">
                        <Calendar className="w-3 h-3" aria-hidden="true" />
                        <span>{dateStr}</span>
                      </span>
                      <span className="shrink-0" aria-hidden="true">•</span>
                      {/* post.tone é o parágrafo de instrução do manifesto, e
                          num cartão de listagem ele empurra o layout. */}
                      <span className="text-accent-ink font-semibold truncate" title={post.tone}>
                        {post.approachName || 'Visão do autor'}
                      </span>
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-line text-xs gap-1">
                    <button
                      ...
                      className="px-3 py-1.5 bg-accent-soft hover:bg-accent/20 text-accent-ink font-semibold rounded-control flex items-center space-x-1 transition-all cursor-pointer min-h-[36px] border border-accent/40"
                    >
                    ...
                    {onClonePost && (
                      <button
                        ...
                        className="px-2.5 py-1.5 bg-surface-raised hover:bg-surface text-ink-muted font-semibold rounded-control flex items-center space-x-1 transition-all cursor-pointer min-h-[36px] border border-line/50"
